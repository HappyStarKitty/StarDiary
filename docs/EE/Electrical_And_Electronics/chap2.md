...
凡是具有两个接线端的部分电路，就称为二端网络；视其内部是否包含电源，分为有源二端网络和无源二端网络；常以$N_A$表示有源二端网络，$N_P$表示无源二端网络

无源二端网络的等效电路为一条无源支路，可用一等效电阻表示；有源二端网络则需应用等效电源定理，即<b>戴维南定理</b>和<b>诺顿定理</b>

!!! theorem "戴维南定理"
    1. 一个线性有源二端网络可用<b>一个电压源和一个电阻的串联电路</b>等效
    2. 电压等于<b>开路电压</b>$U_{OC}$
    3. 串联电阻等于<b>除去独立电源后在其端口处等效电阻</b>

!!! theorem "诺顿定理"
    1. 一个线性有源二端网络可用<b>一个电流源和一个电阻的并联电路</b>等效
    2. 电流等于<b>短路电流</b>$I_{SC}$
    3. 并联电阻等于<b>除去独立电源后在其端口处等效电阻</b>

!!! attention "注意"
    1. 被等效的二端网络必须是线性的
    2. 二端网络和外电路之间没有耦合关系（即如果出现受控源，不能是二端网络的电学量影响外电路的电学量）

应用等效电源定理，需要求出有源二端网络的开路电压或短路电流，求出有源二端网络除源后的等效电阻

!!! note "等效电阻求取方法"
    1. 串并联化简法：使用电阻串、并联化简
    2. 外施电压法：在除去独立电源以后的端口处外加一个电压U，求其端口处的电流I，则其端口处的等效电阻即为
        $$R_0=\frac{U}{I}$$
    3. 开短路法：根据戴维南定理和诺顿定理求出开路电压与短路电流，则有
        $$R_0=\frac{U_{OC}}{I_{SC}}$$
    4. 负载实验法
   
!!! attention "注意"
    当有源二段网络中含有受控源时，除去独立电源后，受控源仍保留在网络中，应用外施电压法和开短路法计算等效电阻，而不能使用串并联化简法
...
$X>0$，$\varphi>0$，$i$滞后于$u$，电路为电感性；$X<0$，$\varphi<0$，$i$超前于$u$，电路为电容性；$X=0$，$\varphi=0$，$i$与$u$同相位，电路为电阻性，处于谐振状态
...
!!! question "习题2.4.1"
    ![wfxs](figures/chap2/241_1.png)
    ![wfxs](figures/chap2/241_2.png)
    ![wfxs](figures/chap2/241_3.png)
